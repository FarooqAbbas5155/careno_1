...
class CustomEditTextField extends StatefulWidget {
  ...
  final _state = _CustomEditTextFieldState();

  @override
  _CustomEditTextFieldState createState() {
    return _state;
  }
                ...
                suffixIcon: widget.suffix ??
                    (isPasswordField
                        ...
                        : (widget.asyncValidator != null
                            ...
                            : null)),
                hintStyle: TextStyle(
                    color: widget.hintColor ?? Colors.black.withOpacity(.5),
                    fontFamily: "Urbanist",
                    fontSize: 15.sp,
                    fontWeight: FontWeight.w500),
