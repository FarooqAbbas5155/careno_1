        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              buildDetail("Per Day Rent", "${addHostVehicle.currency}${addHostVehicle.vehiclePerDayRent}"),
              buildDetail("Per Hours Rent", "${addHostVehicle.currency}${addHostVehicle.vehiclePerHourRent}"),
              Text(
